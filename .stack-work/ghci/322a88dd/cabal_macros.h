...
/* package ccg-infer-0.1.0.0 */
#ifndef VERSION_ccg_infer
#define VERSION_ccg_infer "0.1.0.0"
#endif /* VERSION_ccg_infer */
#ifndef MIN_VERSION_ccg_infer
#define MIN_VERSION_ccg_infer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ccg_infer */
...
#define CURRENT_COMPONENT_ID "ccg-infer-0.1.0.0-LRHx0bIt6a62CRm2on7cvb-ccg-infer"
