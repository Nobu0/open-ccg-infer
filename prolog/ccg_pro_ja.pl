:- set_prolog_flag(write_options, [max_depth(0)]).
...
jewd(11,[。],[],                   [],['.']).
jeno(11,  [249,250],[], [],[242,245]).
jeno(11,  [251,252,253],[254,255], [246],[247,248,249,250,251,252,253]).
jeno(11,  [256],[257,258,259,260,261,262], [267,268],[269]).
jeno(11,  [263],[], [264,265],[266]).
jeno(11,  [264],[], [],[274]).
jeno(11,  [265],[266,267,268], [270,271,272],[273]).
jeno(11,  [269],[], [],[263]).
jeno(11,  [270],[], [],[261,262]).
jeno(11,  [271],[272,273], [],[260]).
jeno(11,  [274],[275,276], [],[259]).
jeno(11,  [277,278],[279], [256],[257,258]).
jeno(11,  [280],[281], [],[255]).
jeno(11,  [282,283,284],[], [],[254]).
jeno(11,  [285],[], [],[275]).
...
cat(長い, fun(s,np,b)).
cat(は, fun(s,np,f)).
cat('を', fun(fun(s,np,b), np, f)).
cat(により, fun(fun(s,np,b), np, f)).
cat(ある, fun(s,np,b)).

% --- 助詞を含む複合チャンク ---
jp_chunk_cat(Chunk, KX) :- member(CD,Chunk), cat(CD,KX).
